...
export default function Solution({ para, heading, points }) {
  // console.log(para);
          ...
          <div className="lg:pt-20 pt-0 lg:pb-20 sm:pb-12 pb-8 lg:w-3/4 w-full lg:border-l border-zinc-200 lg:pl-8 lg:mt-0 sm:mt-8 mt-4 ">
            <div>
              <div className="lg:w-[752px]">
                {router.pathname == "/casestudy-sxm" && (
                  <>
                    <p className="f-f-s font-normal text-base text-zinc-600">
                      {para.para}
                    </p>
                    <p className="f-f-s font-normal text-base text-zinc-600 mt-8">
                      {heading.title}
                    </p>
                  </>
                )}
